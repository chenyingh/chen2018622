 ...
 */
function login() {
    return location.href = "http://sso.chenyingh.top/page/login";
}
function regist() {
    return location.href = "http://sso.chenyingh.top/page/register";
}
...
function search(a) {
    var b = "http://www.chenyingh.top/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
